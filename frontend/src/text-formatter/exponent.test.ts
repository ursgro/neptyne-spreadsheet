...
test.each<[number, string, string, string, string]>([
...
])("Exponent", (value, expected1, expected2, expected3, expected4) => {
  expect(formatNumberToText(value, "#0.0E+0")).toBe(expected1);
  expect(formatNumberToText(value, "##0.0E+0")).toBe(expected2);
  expect(formatNumberToText(value, "###0.0E+0")).toBe(expected3);
  expect(formatNumberToText(value, "####0.0E+0")).toBe(expected4);
});
