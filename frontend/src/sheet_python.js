...
export function register_sheet_python(CodeMirror) {
  "use strict";
  ...
  CodeMirror.defineMode("sheet-python", function (conf, parserConf) {
  ...
  CodeMirror.defineMIME("text/x-sheet-python", "python");
}
